...
<script>
	export default 
	{
		...
		mounted()
		{
			this.$refs.description.set(this.post.description);
			this.$refs.categories.set(this.post.categories_id,this.post.primary_category);
		},
		methods:
		{
			submit()
			{
				...
				.then(function(response)
				{
					...
					return this.$toastr.success("Post atualizado com sucesso");
				}.bind(this))
